...
var RatingBar = function( element, options ) {
   ...
   $me.on( 'mousemove', function( e ) {
      ...
      value_questgirl = $me.attr( 'questgirl');
      $('.span_'+value_questgirl).text(vl);
   ...
   $me.on( 'mouseout', function( e ) {
      ...
      $me.attr( 'data-value', supervl );
      value_questgirl = $me.attr( 'questgirl');
      $('.span_'+value_questgirl).text(supervl);
      $fg.css( 'width', Math.round( superow )+'px' );
